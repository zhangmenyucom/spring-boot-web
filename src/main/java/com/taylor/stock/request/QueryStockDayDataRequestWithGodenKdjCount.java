 ...
 */
@Slf4j
public class QueryStockDayDataRequestWithGodenKdjCount extends Thread {

    private RecmdStockService recmdStockService;

    private List<String> stockCodeList;

    private GodenKdjCountStrategy strategy;

    public QueryStockDayDataRequestWithGodenKdjCount(GodenKdjCountStrategy strategy, RecmdStockService recmdStockService, List<String> stockCodeList, String taskName) {
        super(taskName);
