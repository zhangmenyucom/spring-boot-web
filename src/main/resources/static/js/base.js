...
(function ($) {
    ...
    $(".dialog").click(function () {
        myWindow=window.open($(this).attr("href"), "sample", "fullscreen=no,width=1200,left=0,top=0,height=600,toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes, copyhistory=no;");
        myWindow.focus();
