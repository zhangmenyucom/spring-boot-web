...
(function ($) {
    ...
    $(".start_choose_by_type_all").click(function () {
        var temp = $(this);
        $.ajax({
            url: "/stock/api/start_choose_by_type",
            type: 'get',
    ...
    $(".dialog").click(function () {
        window.open($(this).attr("href"), "sample", "fullscreen=no,toolbar=no,top=0,left=0,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes, copyhistory=no;");
    });
})(jQuery);